...
DATA = Path("data")
OUT = Path("outputs/exp012_sed_pseudolabel")
...
PSEUDO_PROBS = Path("mels/train_soundscapes_pseudo_probs_exp012_sedclip.npy")
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        ckpt = {
            ...
            "experiment": "exp012_sed_pseudolabel",
            "mean_weight": 0.5,
            "max_weight": 0.5,
            "dropout": 0.2,
            "pseudo_loss_weight": PSEUDO_LOSS_WEIGHT,
            "pseudo_probs": str(PSEUDO_PROBS),
            "teacher": "0.95*exp011_sed_epoch06 + 0.05*exp006_clip_epoch05_epoch06",
        }
