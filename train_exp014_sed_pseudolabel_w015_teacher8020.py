...
DATA = Path("data")
OUT = Path("outputs/exp014_sed_pseudolabel_w015_teacher8020")
...
PSEUDO_PROBS = Path("mels/train_soundscapes_pseudo_probs_exp014_sedclip8020.npy")
...
def main():
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        ckpt = {
            ...
            "experiment": "exp014_sed_pseudolabel_w015_teacher8020",
            "mean_weight": 0.5,
            "max_weight": 0.5,
            "dropout": 0.2,
            "pseudo_loss_weight": PSEUDO_LOSS_WEIGHT,
            "pseudo_probs": str(PSEUDO_PROBS),
            "teacher": ".80*exp011_sed_epoch06 + 0.20*exp006_clip_epoch05_epoch06",
        }
